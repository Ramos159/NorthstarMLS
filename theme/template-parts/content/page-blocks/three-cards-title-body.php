...
?>
<section>
    <div data-animation="animate__fadeIn" class="opacity-0 pt-12 md:pt-[120px] text-center pb-12 px-4 md:px-20">
    			...
    			<div data-animation="animate__fadeInUp" class="opacity-0 rounded-xl md:h-[525px] md:w-[360px] shadow-xl mb-10">
    				...
    				<div class="pt-6 px-8">
    					...
    					<a href="<?php echo $card['link']?>">
                            <p class="pb-4 flex text-brand-headline-blue">read more <img class="h-3 pl-4 mt-1" src="<?php echo get_template_directory_uri() . '/public/blue-arrow-right.png';?>"></img></p>
                        </a>
    				</div>
    			</div> 
            <?php endforeach;?>
