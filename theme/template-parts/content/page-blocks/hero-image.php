...
<section>
    <div class="<?php if($has_blue_bg): echo '.blue-hero'; endif;?> px-4 md:px-0 md:flex md:flex-row-reverse w-full md:h-[480px] pt-8 pb-8 md:pb-16 text-center md:text-start">
		<div data-animation="animate__fadeInRight" class="opacity-0 shadow-xl h-[225px] md:h-[352px] md:mr-0 md:ml-auto rounded-3xl md:rounded-none md:rounded-l-3xl bg-cover md:min-w-[619px] mb-8 md:mb-0" style="background-image: url(<?php echo $hero_image['url']; ?>); background-position: center;"></div>
